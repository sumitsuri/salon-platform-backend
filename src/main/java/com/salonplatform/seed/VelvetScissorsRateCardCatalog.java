    ...
    private static RateCardCatalog.TopCategoryDef women() {
        return new RateCardCatalog.TopCategoryDef("Women", 2, List.of(
                ...
                sub("Healthy Hair Spa", 4, List.of(
                        ...
                        s("Herbal Aromatherapy Spa — Waist", 1799, 90),
                        s("Keratin Hair Spa — Shoulder", 1599, 90),
                        s("Keratin Hair Spa — Mid Back", 1699, 90),
                ...
                sub("Waxing · Honey", 7, List.of(
                        s("Upper Lip Wax (Honey)", 249, 10),
                        s("Chin Wax (Honey)", 99, 10),
                        s("Sides Wax (Honey)", 79, 10),
                        s("Full Face Wax (Honey)", 549, 25),
                        s("Under Arms Wax (Honey)", 249, 15),
                        s("Half Arms Wax (Honey)", 349, 20),
                        s("Full Arms Wax (Honey)", 549),
                        s("Half Legs Wax (Honey)", 449),
                        s("Full Legs Wax (Honey)", 699, 45),
                        s("Stomach Wax (Honey)", 499, 25),
                        s("Full Front Wax (Honey)", 649, 35),
                        s("Full Back Wax (Honey)", 699, 40),
                        s("Bikini Wax (Honey)", 1449, 40),
                        s("Full Body Wax (Honey)", 2449, 90)
                )),
